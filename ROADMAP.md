...
| Phase 0 | Foundation + Event Backbone | Week 1–2 | 20% | 🟡 in progress (scaffold done) |
...
- [ ] Seed 8 roles (Owner, Manager, Accountant, Cashier, Kitchen, Inventory, Staff, Viewer)
- [ ] Company + Branch CRUD, branch switcher
